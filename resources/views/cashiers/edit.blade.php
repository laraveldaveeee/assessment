...
<div id="content" class="content">
				...
				<!-- end breadcrumb -->
				<!-- begin page-header -->
				<h1 class="page-header text-white">Edit Cashier </h1>
				<!-- end page-header -->
				<!-- begin panel -->
				<div class="panel panel-inverse">
					<div class="panel-heading">
						<h4 class="panel-title">Edit Cashier</h4>
					...
					<div class="panel-body bg-dark">
						<form method="POST" action="{{ route('cashiers.update', $cashier) }}">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control bg-dark text-white" name="name" value="{{ $cashier->name }}">
							</div>
							<div class="form-group">
								<label class="text-white">Username</label>
								<input type="text" class="form-control bg-dark text-white" name="username" value="{{ $cashier->username }}">
							</div>
