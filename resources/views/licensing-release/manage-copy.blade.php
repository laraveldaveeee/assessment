      ...
      <div class="table-responsive">
         <div class="panel-body">
            <form id="signatureform" action="/licensing-release/{{ $licensingRelease->id }}"  method="POST"  enctype="multipart/form-data">
              ...
              <div class="form-group">
                    <textarea id="sig-dataUrl" class="form-control" rows="5" name="signature" hidden="">Data URL for your signature will go here!</textarea>
              </div>
...
<div class="row">
   <div class="col-md-12">
      ...
      <div class="form-group">
         <img id="sig-image"  src="{{ Storage::url($licensingRelease->signature) }}" height="" width="1000px">
      </div>
      @endif
   </div>
</div>
