       ...
       <div class="profile">
          <div class="profile-header">
             ...
             <ul class="profile-header-tab nav nav-tabs" style="background: #f0f8ff21">
                <li class="nav-item"><a class="nav-link active" data-toggle="tab" style="color: #fff;">&nbsp;I am Accounting</a></li>
...
<script>
   ...
   $('#applicant-table').DataTable({
       ...
       ajax: '{!! route('accounting/home.index') !!}',
       columns: [
           { data: 'id' },
           ...
           { data: 'applicant.address',},  
           {
               ...
               "defaultContent": "<span class='label label-green'>Approved </span>"       
           },
