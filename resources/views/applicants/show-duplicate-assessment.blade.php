      ...
      <div class="panel-body">
         <form method="POST" action="/assesments-status/{{ $assessment->id }}">
            ...
            <div class="form-group">
               ...
               <input type="date" name="date_validity" class="form-control" value="{{ Carbon\Carbon::parse($assessment->date_validity)->format('Y-m-d') }}">
            </div>
            @else 
            <div class="form-group">
               <label>Date on or before:</label>
               <input type="date" name="date_validity" class="form-control">
            </div>
            @endif
