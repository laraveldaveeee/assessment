...
<div class="container" >
    ...
    <div class="form-group" style="margin-top: 5%; margin-left: 7%;">
        ...
        <table class="" style="width: 50%;">
            <tr>
                <td height="68" colspan="2"><b>{{ convert_number_to_words($sufTotal) }} Pesos Only</b></td>
            </tr>
        </table>
    </div>  
