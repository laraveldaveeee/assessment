...
<div id="content" class="content">
	<h1 class="page-header">Pending Carrier/Company</h1>
	{{-- <cashier-pending></cashier-pending> --}}
	<div class="panel panel-inverse">
		...
		<div class="panel-body bg-dark">
			<table class="table table-bordered text-white" id="carriers-table">
				<thead>
					<tr>
						<th>ID</th>
						<th>SOA NO</th>
				 ...
				 <tbody>
				 	...
				 	<tr>
				 		<td>{{ $carrier->id }}</td>
				 		<td>{{ $carrier->carrier->applicant ?? Null }}</td>
				 		<td>{{ $carrier->carrier->address ?? Null }}</td>
				 		<td>{!! $carrier->assessment->carrier_status ?? '<span class="label label-primary">For Payment </span>' !!}</td>
				 		<td><a href="/cashier/{{ $carrier->id }}/carrier-assessments" class="btn btn-outline-primary btn-xs"><i class="fa fa-pencil"></i> Manage</a></td>
				 	</tr>
				 	@endforeach
				 </tbody>
			</table>
