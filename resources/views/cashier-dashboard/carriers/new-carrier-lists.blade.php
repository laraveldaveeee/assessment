...
<div id="content" class="content">
	<h1 class="page-header "> New Carrier Company</h1>
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<table class="table table-bordered " id="cashier-new-carrier-table" >
				<thead>
					<tr>
						<th>ID</th>
						<th>SOA NO</th>
...
<script> 
	 ...
	 $('#cashier-new-carrier-table').DataTable({
	      	  //"ordering":'true',
          "order": [0, 'desc'],
          processing: true,
          serverSide: true,
          ajax: '{!! route('cashier.new-carrier-list.newCarrierLists') !!}',
          columns: [
              { data: 'id'},
              { data: 'soa_number'},
